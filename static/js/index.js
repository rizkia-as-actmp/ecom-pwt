...
hamburgerButtonElement.addEventListener("click", () => {
    ...
    if (drawerElement.classList.contains("open")) {
        hamburgerButtonElement.innerText = "X"
    } else {
...
// sp1.addEventListener("scroll", () => {
//     let scrollPercentage = Math.floor((150 - (sp1.scrollLeft * 4)) / 150 * 100)
//     if (scrollPercentage < 0) {
//         scrollPercentage = 0
//     }

//     sp1.getElementsByClassName("jargon")[0].style.opacity = `${scrollPercentage}%`
//     sp1.getElementsByClassName("jargon")[0].style.transform = `scale(${scrollPercentage}%)`
